...
var scrollAnimatorEntertain = function() {
    ...
    var hT = jQuery('#entertain').offset().top,  //topPos is the number of pixels from the top of the closest relatively positioned parent element.
        hH = jQuery('#entertain').outerHeight(), // Get the current computed height for the first element in the set of matched elements
...
// Animate Play
        ...
        jQuery(window).off("scroll", scrollAnimatorEntertain);
        // alert("scrollAnimatorEntertain_off");

    }
};

jQuery(window).scroll(scrollAnimatorEntertain);
...
var scrollAnimatorEarn = function() {
    ...
    var hT = jQuery('#destination').offset().top,
        hH = jQuery('#destination').outerHeight(),
...
// Animate Play
        ...
        jQuery(window).off("scroll", scrollAnimatorEarn);
...
// Animate Play
        ...
        jQuery(window).off("scroll", scrollAnimatorSell);

    }

};

jQuery(window).scroll(scrollAnimatorSell);
...
// Animate Play
        ...
        jQuery(window).off("scroll", scrollAnimatorManage);
